...
public class Alcalinos extends AppCompatActivity implements ElementoAdapter.ContactsAdapterListener {
    ...
    private static final String URL = "https://gist.githubusercontent.com/rogersant0sxiu/9cf0f621f4d26552fd841533b4fd6676/raw/a8b8683850990390933008a9f94a343503adca10/alcalinos.json";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_alcalinos);
        ...
        getSupportActionBar().setTitle("Alcalinos");
