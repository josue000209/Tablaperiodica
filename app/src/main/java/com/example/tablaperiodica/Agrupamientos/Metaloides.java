...
public class Metaloides extends AppCompatActivity implements ElementoAdapter.ContactsAdapterListener{
    ...
    private static final String URL = "https://gist.githubusercontent.com/rogersant0sxiu/979832f9c735749070c738c8052a95d7/raw/1e8dd53538645b823106d606b286e070a1b9b5dd/metaloides";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_metaloides);
        ...
        getSupportActionBar().setTitle("Metaloides");
    ...
    public void onContactSelected(Elemento contact) {
        Intent i =  new Intent(this, DescMetaloides.class);
