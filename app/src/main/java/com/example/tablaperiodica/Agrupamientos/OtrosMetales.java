...
public class OtrosMetales extends AppCompatActivity implements ElementoAdapter.ContactsAdapterListener{
    ...
    private static final String URL = "https://gist.githubusercontent.com/rogersant0sxiu/d64b42ef3ae85d2ee4c356c8dbddaac5/raw/17c7e6afe1063283d3f73cce9fc87f05edd8b770/otrosmetales";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_otros_metales);
        ...
        getSupportActionBar().setTitle("Otros Metales");
    ...
    public void onContactSelected(Elemento contact) {
        Intent i =  new Intent(this, DescOtrosMetales.class);
