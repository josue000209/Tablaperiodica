...
public class DescActinidos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desc_actinidos);

        stackContent = (LinearLayout) findViewById(R.id.contendorDatos9);
        ...
        ImageView img = (ImageView) findViewById(R.id.ImgEle9);
        TextView txt = (TextView) findViewById(R.id.txtTitulo9);
        txt.setText(ID);

        Glide.with(DescActinidos.this)
                .load(ImgUrl)
            ...
            public void onComplete(Response status) {
                if (status.isSuccess()){
                    ...
                    try {
                        ...
                        Toast.makeText(DescActinidos.this, "Error: "+e,Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        client.excecute("https://gist.githubusercontent.com/josue000209/fd48cafc9ccb7893da6d3f5c26a5d244/raw/dc7c3cffd1eebf25bc6aeb2b3784481f5deb7500/actinidosInfo.json");
    }
}
