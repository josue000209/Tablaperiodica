...
public class DescAlcalinoterreos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desc_alcalinoterreos);
        ...
        ImageView img = (ImageView) findViewById(R.id.ImgEle);
        TextView txt = (TextView) findViewById(R.id.txtTitulo);
        txt.setText(ID);

        Glide.with(DescAlcalinoterreos.this)
                .load(ImgUrl)
            ...
            public void onComplete(Response status) {
                if (status.isSuccess()){
                    ...
                    try {
                        ...
                        Toast.makeText(DescAlcalinoterreos.this, "Error: "+e,Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        client.excecute("https://gist.githubusercontent.com/josue000209/af01efd0f9584b6fde88152c8681423c/raw/9ec6031c283265d7292534b349516bbd04c0b468/Alcalinoterreos.json");
    }
}
