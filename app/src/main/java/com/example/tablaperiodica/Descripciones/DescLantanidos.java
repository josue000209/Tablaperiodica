...
public class DescLantanidos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desc_lantanidos);

        stackContent = (LinearLayout) findViewById(R.id.contendorDatos10);
        ...
        ImageView img = (ImageView) findViewById(R.id.ImgEle10);
        TextView txt = (TextView) findViewById(R.id.txtTitulo10);
        txt.setText(ID);

        Glide.with(DescLantanidos.this)
                .load(ImgUrl)
            ...
            public void onComplete(Response status) {
                if (status.isSuccess()){
                    ...
                    try {
                        ...
                        Toast.makeText(DescLantanidos.this, "Error: ",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        client.excecute("https://gist.githubusercontent.com/josue000209/e3715e94ab002defc40aeecb144cb5b1/raw/5ed8b0166c24d66412eae145c5833604f6e6e5a2/lantanidos.json");
    }
}
