...
public class DescMetalesTranscision extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desc_metales_transcision);

        stackContent = (LinearLayout) findViewById(R.id.contendorDatos4);
        ...
        ImageView img = (ImageView) findViewById(R.id.ImgEle4);
        TextView txt = (TextView) findViewById(R.id.txtTitulo4);
        txt.setText(ID);

        Glide.with(DescMetalesTranscision.this)
                .load(ImgUrl)
            ...
            public void onComplete(Response status) {
                if (status.isSuccess()){
                    ...
                    try {
                        ...
                        Toast.makeText(DescMetalesTranscision.this, "Error: "+e,Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        client.excecute("https://gist.githubusercontent.com/josue000209/a3813e5aca54ae7fe3b8c8a7598eac73/raw/66949e81313e6738d36077b39b9c9f6e3d0c86b1/Metales_De_transici%25C3%25B3n");
    }
}
