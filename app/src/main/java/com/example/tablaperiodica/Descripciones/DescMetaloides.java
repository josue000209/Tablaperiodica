...
public class DescMetaloides extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desc_metaloides);

        stackContent = (LinearLayout) findViewById(R.id.contendorDatos7);
        ...
        ImageView img = (ImageView) findViewById(R.id.ImgEle7);
        TextView txt = (TextView) findViewById(R.id.txtTitulo7);
        txt.setText(ID);

        Glide.with(DescMetaloides.this)
                .load(ImgUrl)
            ...
            public void onComplete(Response status) {
                if (status.isSuccess()){
                    ...
                    try {
                        ...
                        Toast.makeText(DescMetaloides.this, "Error: "+e,Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        client.excecute("https://gist.githubusercontent.com/josue000209/d6a9d63f3ae57cfdf30a2dfe90d08a46/raw/7df7ec02c83cb626967085d7dbea5ad1ba4b8d1a/metaloides");
    }
}
