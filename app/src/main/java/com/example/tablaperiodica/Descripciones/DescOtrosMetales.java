...
public class DescOtrosMetales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desc_otros_metales);

        stackContent = (LinearLayout) findViewById(R.id.contendorDatos8);
        ...
        ImageView img = (ImageView) findViewById(R.id.ImgEle8);
        TextView txt = (TextView) findViewById(R.id.txtTitulo8);
        txt.setText(ID);

        Glide.with(DescOtrosMetales.this)
                .load(ImgUrl)
            ...
            public void onComplete(Response status) {
                if (status.isSuccess()){
                    ...
                    try {
                        ...
                        Toast.makeText(DescOtrosMetales.this, "Error: "+e,Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        client.excecute("https://gist.githubusercontent.com/josue000209/b0a2bf6cdef2a136b339459308cb7e83/raw/9b207866cfbebe1db6601603089769b6709ca5fa/otrosmetales");
    }
}
